...
class TestDatasetManager:
    ...
    def test_init_loads_datasets(self, mock_datasets_config, temp_dir):
        ...
        with patch("pathlib.Path.exists", return_value=True), patch(
            "builtins.open", mock_open(read_data=json.dumps(mock_datasets_config))
        ):
    ...
    def test_init_file_not_found(self):
        ...
        with patch("pathlib.Path.exists", return_value=False), patch(
            "neurodatahub.datasets.display_error"
        ) as mock_error:
            manager = DatasetManager()
    ...
    def test_list_datasets_no_filter(
        self, mock_dataset_manager, sample_dataset, sample_auth_dataset
    ):
    ...
    def test_list_datasets_auth_filter(
        self, mock_dataset_manager, sample_dataset, sample_auth_dataset
    ):
    ...
    def test_display_datasets_table_with_data(
        self, mock_dataset_manager, sample_dataset
    ):
...
class TestEdgeCases:
    ...
    def test_dataset_manager_with_malformed_config(self):
        ...
        with patch("pathlib.Path.exists", return_value=True), patch(
            "builtins.open", mock_open(read_data=json.dumps(malformed_config))
        ):
            manager = DatasetManager()
