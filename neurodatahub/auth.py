...
class AWSCredentialsAuth(BaseAuthenticator):
    ...
    def authenticate(self) -> bool:
        ...
        try:
            ...
            display_error(
                "Failed to run 'aws configure'. Please set up AWS CLI manually."
            )
            return False
...
class ManualAuth(BaseAuthenticator):
    ...
    def authenticate(self) -> bool:
        ...
        if self.instructions:
            ...
            if website:
                ...
                display_info(
                    "Follow the website instructions to gain access to this dataset"
                )
    ...
    def is_authenticated(self) -> bool:
        ...
        return get_confirmation(
            f"Do you have access to {self.dataset_name}?", default=False
        )
...
class SeleniumAuth(BaseAuthenticator):
    ...
    def _setup_driver(self) -> bool:
        ...
        try:
            ...
            display_info(
                "You may need to install geckodriver: https://github.com/mozilla/geckodriver/releases"
            )
            return False
...
"""
        ...
        return get_confirmation(
            "Have you received approval and download instructions from CamCAN?"
        )

    def is_authenticated(self) -> bool:
        return get_confirmation(
            "Do you have approved access to CamCAN dataset?", default=False
        )
